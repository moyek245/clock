...
Delicious.Mp3 = {
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.mp3$/i)) {
				...
				img.src = 'http://playtagger.googlecode.com/files/play.gif'; img.title = 'Play'
	...
	toggle: function(img, url) {
		if (Delicious.Mp3.playimg == img) Delicious.Mp3.destroy()
			...
			img.src = 'http://playtagger.googlecode.com/files/stop.gif'; img.title = 'Stop'; Delicious.Mp3.playimg = img;
	...
	destroy: function() {
		Delicious.Mp3.playimg.src = 'http://playtagger.googlecode.com/files/play.gif'; Delicious.Mp3.playimg = null
